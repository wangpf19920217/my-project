   	<template>
   		<div class="guide-slider" id="guideSlider">
	        ...
	        <ul class="guide-list">
	            <li class="guide"  v-for="i in items" v-bind:class="{ on:i.active }" >
	                <div class="display">
	                    <div class="icon icon1 animated flipInY"></div>
	                    <div class="title">{{ i.title }}</div>
	                    <div class="introduction">{{ i.jj }}</div>
	                </div>
	                <div class="behind">
	                    <div class="function-list-wrap">
	                    	<ul class="function-list">
	                        	<template v-for="d in i.datas">
								    <li class="function" v-on:click="green($self)"><a class="">{{ d }}</a></li>
							    </template>
	                        </ul>
	                    </div>
	                </div>
...
export default {
  ...
  data () {
    return {
      items: [
	      {title: 'javascript' , jj :'js' ,datas:{
	      	cont:'基础',
	      	cont1:'声明变量',
	      	cont2:'学习......'
	      },active:true},
	      {title: 'jquery' , jj :'JQ' ,datas:{
	      	cont:'基础',
	      	cont1:'声明变量',
	      	cont2:'学习......'
	      }},
	      {title: 'vue1.0' , jj :'vue' ,datas:{
	      	cont:'基础',
	      	cont1:'声明变量',
	      	cont2:'学习......'
	      }},
	      {title: 'node' , jj :'node' ,datas:{
	      	cont:'基础',
	      	cont1:'声明变量',
	      	cont2:'学习......'
	      }},
	      {title: 'webpack' , jj :'打包工具' ,datas:{
	      	cont:'基础',
	      	cont1:'声明变量',
	      	cont2:'学习......'
	      }},
	...
	methods: {
	    green: function (event) {
	      // `this` 在方法里指当前 Vue 实例   .className = 'important'
	      event.target.style.className = 'important'
